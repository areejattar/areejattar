...
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="en"><body><div className="site-watermark" aria-hidden="true"/><Header/>{children}<WhatsAppButton/><Footer/></body></html>}
